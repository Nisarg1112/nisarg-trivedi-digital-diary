...
export default function Talent({ list }) {
  ...
  const mailToContent = `mailto:${process.env.NEXT_PUBLIC_PERSONAL_EMAIL}?subject=I'm%20open%20to%20new%20opportunities&body=Name%3A%0D%0APortfolio%3A%0D%0ALinkedin%3A%0D%0ATwitter%3A`;

  return (
    <>
      <Head>
        <title>{"Nisarg's Talent List"}</title>

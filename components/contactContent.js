...
export default function ContactContent() {
  ...
  function updateClipboard(e) {
    navigator.clipboard.writeText(process.env.NEXT_PUBLIC_PERSONAL_EMAIL).then(
      function () {
  ...
  const mailToLink = `mailto:${process.env.NEXT_PUBLIC_PERSONAL_EMAIL}`;
    ...
    <>
      <div className={styles.row}>
        <div className={styles.stack}>
          ...
          <p className={styles.subText}>{process.env.NEXT_PUBLIC_PERSONAL_EMAIL}</p>
        </div>
      ...
      <div className={styles.row}>
        <div className={styles.stack}>
          ...
          <p className={styles.subText}>
            {"For advice or new opportunities, it's easier to come and chat live"}
          </p>
        </div>
        <a
          href={process.env.NEXT_PUBLIC_CALENDER_LINK}
          target="_blank"
          rel="noopener noreferrer"
          className={
      ...
      <div className={styles.row}>
        <div className={styles.stack}>
          ...
          <p className={styles.subText}>{"I'm most active on LinkedIn"}</p>
        </div>
        <div className={styles.flexRow}>
          <a
            className={styles.textButton}
            href="https://www.linkedin.com/in/nisargtrivedi1112/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
